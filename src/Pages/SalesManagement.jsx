...
const OrderPage = () => {
  ...
  return {
    ...
    percentCanceled: orders.length > 0 ? Math.round((canceled / orders.length) * 100) : 0,
  ...
  <div className="bg-white p-4 rounded-xl shadow text-center">
    ...
    <p className="text-xs text-gray-400">{summary.percentTotal}% of total</p>
  </div>
  <div className="bg-white p-4 rounded-xl shadow text-center">
    ...
    <p className="text-xs text-gray-400">{summary.percentDone}% of total</p>
  </div>
  <div className="bg-white p-4 rounded-xl shadow text-center">
    <h3 className="text-sm font-semibold text-gray-500">Canceled</h3>
    <p className="text-2xl font-bold text-yellow-500">{summary.canceled}</p>
    <p className="text-xs text-gray-400">{summary.percentCanceled}% of total</p>
  </div>
  <div className="bg-white p-4 rounded-xl shadow text-center">
    <h3 className="text-sm font-semibold text-gray-500">Total Items</h3>
    <p className="text-2xl font-bold text-blue-500">{summary.totalProducts}</p>
    <p className="text-xs text-gray-400">{summary.percentItems}% of total</p>
  </div>
</div>
